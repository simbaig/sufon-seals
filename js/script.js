(function ($) {
	...
	if (
		$(".single-shop .image-carousel").length &&
		$(".single-shop .thumbs-carousel").length
	) {
	...
	if ($(".timer").length) {
		...
		$(".cs-countdown")
			...
			.on("update.countdown", function (event) {
				var $this = $(this).html(
					event.strftime(
						'<div class="count-col"><h6>days</h6><span>%D</span></div> <div class="count-col"><h6>Hours</h6><span>%H</span></div> <div class="count-col"><h6>Minutes</h6><span>%M</span></div> <div class="count-col"><h6>Seconds</h6><span>%S</span></div>'
					)
				);
			});
	}
